 ...
 *
 * Android crops launcher icons to whatever shape the device theme uses —
 * circle, squircle, teardrop. A maskable icon must therefore keep everything
 * important inside the middle ~80% "safe zone", or the hornbill loses its beak
 * to the crop. That is the only difference from `app/icon.tsx`: same mark,
 * scaled down with padding around it.
 */
export async function GET() {
  return new ImageResponse(
    (
      ...
      >
        {/* ~60% of the canvas, comfortably inside the safe zone. */}
