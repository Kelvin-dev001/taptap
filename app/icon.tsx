...
/**
 * App icon, generated rather than checked in.
 *
 * `next/og` renders this to PNG at request time and caches it, so there is no
 * binary asset in the repo, no image tooling in the build, and the mark is
 * defined in one place alongside the sidebar logo. PNG rather than SVG because
 * iOS home-screen icons and several Android launchers still require it.
 */
